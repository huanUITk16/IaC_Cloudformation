...
3. Upload các file module .yml lên trên S3 Bucket. Ví dụ upload module VPC lên S3, upload file modules/VPC/fragments/vpcmodule.yml. Tương tự cho các module EC2 và SecurityGroup
